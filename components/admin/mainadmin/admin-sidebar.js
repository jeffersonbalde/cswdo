class AdminDashboardSidebar extends HTMLElement {
  constructor() {
    super()
    ...
    this.componentMap = {
      ...
      "accomplishment-reports": {
        ...
        component: "accomplishment-reports",
      },
      "chatbot-interface": {
        title: "Chatbot",
  ...
  loadUserData() {
    try {
      ...
      if (adminRoleElement) {
        adminRoleElement.textContent = 'NONE'
      }
      if (adminNameElement) {
        adminNameElement.textContent = 'none'
      }
    }
  }
      ...
      <div class="sidebar">
        ...
        <div class="admin-section">
          ...
          <div class="admin-info">
            ...
            <div class="admin-name">Main Admin</div>
          </div>
        </div>
        ...
        <nav class="nav-menu">
          ...
          <button class="nav-item" data-view="accomplishment-reports">
            <span class="nav-icon">📊</span>
            <span class="nav-text">ACCOMPLISHMENT REPORTS</span>
          </button>
          <button class="nav-item" data-view="chatbot-interface">
            <span class="nav-icon">🤖</span>
            <span class="nav-text">CHATBOT</span>
          </button>
          <button class="nav-item" data-view="manage-users">
            <span class="nav-icon">👥</span>
...
customElements.define("admin-sidebar", AdminDashboardSidebar)
