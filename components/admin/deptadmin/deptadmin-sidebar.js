class WebAdminDashboardSidebar extends HTMLElement {
  constructor() {
    ...
    this.componentMap = {
      ...
      "feedbacks-view": {
       ...
       "createaccomplishment-reports": {
        title: "Create Accomplishment Reports",
        component: "createaccomplishment-reports",
      },
    };
  }
  ...
  loadUserData() {
    try {
      ...
      if (adminRoleElement) {
        adminRoleElement.textContent = 'DEPARTMENT ADMIN'
      }
      if (adminNameElement) {
        adminNameElement.textContent = 'department User'
      }
    }
  }
      ...
      <div class="sidebar">
        ...
        <div class="admin-section">
          ...
          <div class="admin-info">
            <div class="admin-role">DEPARTMENT ADMIN</div>
            <div class="admin-name">department User</div>
          </div>
        </div>
        ...
        <nav class="nav-menu">
          ...
          <button class="nav-item" data-view="createaccomplishment-reports">
            <span class="nav-icon">📊</span>
            <span class="nav-text">CREATE REPORTS</span>
          </button>
        </nav>
...
customElements.define("deptadmin-sidebar", WebAdminDashboardSidebar);
