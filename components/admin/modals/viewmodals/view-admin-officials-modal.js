class ViewAdminOfficialsModal extends HTMLElement {
  constructor() {
    super();
  ...
  initializeElements() {
    // Modal controls
    this.modal = this.shadowRoot.getElementById("viewAdminOfficialModal");
    this.form = this.shadowRoot.getElementById("viewAdminOfficialForm");
    ...
    this.errorDiv = this.shadowRoot.getElementById("viewAdminOfficialError");
  }
  ...
  async fetchOfficialDetails(officialId) {
    try {
      ...
      const res = await fetch("./php_folder/manageAdminOfficials.php", {
        method: "POST",
      ...
      if (json.success && json.data) {
        ...
        this.department.value = data.dept ?? "admin";
  ...
  async handleSubmit() {
    ...
    const dept = (this.department.value || "").trim() || "admin";
    ...
    confirmModal.addEventListener("confirm-save", async (e) => {
      ...
      this.savedFormData = {
        ...
        name,
        position,
        dept: dept || this.originalData.dept || 'admin',
      ...
      try {
        ...
        submitFormData.append("dept", dept || this.originalData.dept || 'admin');
        ...
        if (result.success) {
          ...
          successModal.setAttribute("message", "✅ Administrative Official Updated Successfully!");
  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <div id="viewAdminOfficialModal" class="modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-bg-logo"></div>
            <div class="modal-header">
              <h5 id="viewAdminOfficialTitle" class="modal-title">View Administrative Official</h5>
              <button type="button" id="closeViewModal" class="btn-close">&times;</button>
            </div>
            <div class="modal-body">
              <div id="viewAdminOfficialError" class="alert alert-danger"></div>
              <form id="viewAdminOfficialForm">
                  ...
                  <div class="form-section">
                    <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="department" name="department" class="form-control" value="admin" readonly>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group">
            ...
            <div class="modal-footer">
              <button type="submit" id="saveChangeBtn" class="btn btn-primary" form="viewAdminOfficialForm" disabled>Save changes</button>
...
customElements.define("view-admin-officials-modal", ViewAdminOfficialsModal);
