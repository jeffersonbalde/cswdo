class ViewSectorialOfficialsModal extends HTMLElement {
  constructor() {
    super();
  ...
  initializeElements() {
    // Modal controls
    this.modal = this.shadowRoot.getElementById("viewSecOfficialModal");
    this.form = this.shadowRoot.getElementById("viewSecOfficialForm");
    ...
    this.errorDiv = this.shadowRoot.getElementById("viewSecOfficialError");
  }
  ...
  async fetchOfficialDetails(officialId) {
    try {
      ...
      const res = await fetch("./php_folder/manageSecOfficials.php", {
        method: "POST",
      ...
      if (json.success && json.data) {
        ...
        this.department.value = data.dept ?? "sec";
  ...
  async handleSubmit() {
    ...
    const dept = (this.department.value || "").trim() || "sec";
    ...
    confirmModal.addEventListener("confirm-save", async (e) => {
      ...
      this.savedFormData = {
        ...
        name,
        position,
        dept: dept || this.originalData.dept || 'sec',
      ...
      try {
        ...
        submitFormData.append("dept", dept || this.originalData.dept || 'sec');
        ...
        if (result.success) {
          ...
          successModal.setAttribute("message", "✅ Sectoral Official Updated Successfully!");
  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <div id="viewSecOfficialModal" class="modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-bg-logo"></div>
            <div class="modal-header">
              <h5 id="viewSecOfficialTitle" class="modal-title">View Sectoral Official</h5>
              <button type="button" id="closeViewModal" class="btn-close">&times;</button>
            </div>
            <div class="modal-body">
              <div id="viewSecOfficialError" class="alert alert-danger"></div>
              <form id="viewSecOfficialForm">
                  ...
                  <div class="form-section">
                    <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="department" name="department" class="form-control" value="sec" readonly>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group">
            ...
            <div class="modal-footer">
              <button type="submit" id="saveChangeBtn" class="btn btn-primary" form="viewSecOfficialForm" disabled>Save changes</button>
...
customElements.define("view-sectorial-officials-modal", ViewSectorialOfficialsModal);
