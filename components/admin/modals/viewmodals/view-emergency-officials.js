class ViewEmergencyOfficialsModal extends HTMLElement {
  constructor() {
    super();
  ...
  initializeElements() {
    // Modal controls
    this.modal = this.shadowRoot.getElementById("viewEmergencyOfficialModal");
    this.form = this.shadowRoot.getElementById("viewEmergencyOfficialForm");
    ...
    this.errorDiv = this.shadowRoot.getElementById("viewEmergencyOfficialError");
  }
  ...
  async fetchOfficialDetails(officialId) {
    try {
      ...
      const res = await fetch("./php_folder/manageEmergencyOfficials.php", {
        method: "POST",
      ...
      if (json.success && json.data) {
        ...
        this.department.value = data.dept ?? "em";
  ...
  async handleSubmit() {
    ...
    const dept = (this.department.value || "").trim() || "em";
    ...
    confirmModal.addEventListener("confirm-save", async (e) => {
      ...
      this.savedFormData = {
        ...
        name,
        position,
        dept: dept || this.originalData.dept || 'em',
      ...
      try {
        ...
        submitFormData.append("dept", dept || this.originalData.dept || 'em');
        ...
        if (result.success) {
          ...
          successModal.setAttribute("message", "✅ Emergency Official Updated Successfully!");
  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <div id="viewEmergencyOfficialModal" class="modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-bg-logo"></div>
            <div class="modal-header">
              <h5 id="viewEmergencyOfficialTitle" class="modal-title">View Emergency Official</h5>
              <button type="button" id="closeViewModal" class="btn-close">&times;</button>
            </div>
            <div class="modal-body">
              <div id="viewEmergencyOfficialError" class="alert alert-danger"></div>
              <form id="viewEmergencyOfficialForm">
                  ...
                  <div class="form-section">
                    <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="department" name="department" class="form-control" value="em" readonly>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group">
            ...
            <div class="modal-footer">
              <button type="submit" id="saveChangeBtn" class="btn btn-primary" form="viewEmergencyOfficialForm" disabled>Save changes</button>
...
customElements.define("view-emergency-officials-modal", ViewEmergencyOfficialsModal);
