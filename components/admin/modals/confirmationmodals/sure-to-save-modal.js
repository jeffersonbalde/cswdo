class ConfirmSaveModal extends HTMLElement {
    constructor() {
      super();
    ...
    initializeElements() {
      this.modal = this.shadowRoot.getElementById("confirmSaveModal");
      this.yesBtn = this.shadowRoot.getElementById("confirmYesBtn");
      this.noBtn = this.shadowRoot.getElementById("confirmNoBtn");
      this.closeBtn = this.shadowRoot.getElementById("closeConfirmModal");
    }
    ...
    initEventListeners() {
      ...
      // Yes button - dispatch confirm event
      this.yesBtn.addEventListener("click", () => {
        this.dispatchEvent(
          new CustomEvent("confirm-save", {
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <button type="button" id="closeConfirmModal" class="btn-close">&times;</button>
              </div>
              <div class="modal-body">
                <div class="confirm-icon">❓</div>
                <p class="confirm-message">Are you sure to save your entries?</p>
              </div>
  ...
  customElements.define("sure-to-save-modal", ConfirmSaveModal);