class AddCWOfficialsModal extends HTMLElement {
  constructor() {
    super();
  ...
  initializeElements() {
    this.modal = this.shadowRoot.getElementById("addCWOfficialsModal");
    this.form = this.shadowRoot.getElementById("addCWOfficialsForm");
    ...
    this.errorDiv = this.shadowRoot.getElementById("addCWOfficialsError");
  }
  ...
  showLoadingState() {
    ...
    this.loadingState.setAttribute("subheader", "Saving official entry");
  ...
  hasUserInput() {
    ...
    // Department is auto-filled to "cw"; ignore it for user input detection
  ...
  async fetchNewEmployeeId() {
    try {
      ...
      console.log("🪵 Raw response from PHP (CW):", text);
      ...
      if (json.success) {
        ...
        console.log("✅ Loaded next Employee ID (CW):", json.employeeId);
      } else {
    ...
    confirmModal.addEventListener("confirm-save", async (e) => {
      if (e.detail.confirmed) {
        ...
        try {
          ...
          console.log("🔄 Sending CW form data:");
          ...
          console.log("📥 Raw response from server (CW):", responseText);
  ...
  render() {
    this.shadowRoot.innerHTML = `
              ...
              <div id="addCWOfficialsModal" class="modal">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-bg-logo"></div>
                          <div class="modal-header">  
                              <h5 id="addCWOfficialsTitle" class="modal-title">Add Child and Youth Welfare Official</h5>
                              <button type="button" id="closeAddModal" class="btn-close">&times;</button>
                          </div>
                          <div class="modal-body">
                              <div id="addCWOfficialsError" class="alert alert-danger"></div>
                              <form id="addCWOfficialsForm">
                                      ...
                                      <div class="form-section">
                                          <div class="form-row">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" id="department" name="department" class="form-control" value="cw" required readonly>
                                              </div>
                                          </div>
                                          <div class="form-row">
                                              <div class="form-group">
                          ...
                          <div class="modal-footer">
                              <button type="submit" id="saveAddBtn" class="btn btn-primary" form="addCWOfficialsForm">Save Official</button>
...
customElements.define("add-cw-officials-modal", AddCWOfficialsModal);
