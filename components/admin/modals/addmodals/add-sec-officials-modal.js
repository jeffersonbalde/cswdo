class AddSecOfficialsModal extends HTMLElement {
  constructor() {
    super();
  ...
  initializeElements() {
    this.modal = this.shadowRoot.getElementById("addSecOfficialsModal");
    this.form = this.shadowRoot.getElementById("addSecOfficialsForm");
    ...
    this.errorDiv = this.shadowRoot.getElementById("addSecOfficialsError");
  }
  ...
  hasUserInput() {
    ...
    // Department is auto-filled to "sec"; ignore it for user input detection
  ...
  async fetchNewEmployeeId() {
    try {
      ...
      console.log("🪵 Raw response from PHP (SEC):", text);
      let json; try { json = JSON.parse(text); } catch (err) { this.showError("Server returned invalid response. Check backend."); return; }
    ...
    confirmModal.addEventListener("confirm-save", async (e) => {
      if (e.detail.confirmed) {
        ...
        try {
          ...
          console.log("🔄 Sending SEC form data:");
          ...
          console.log("📥 Raw response from server (SEC):", responseText);
          let result;
          try {
  ...
  render() {
    this.shadowRoot.innerHTML = `
              ...
              <div id="addSecOfficialsModal" class="modal">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-bg-logo"></div>
                          <div class="modal-header">  
                              <h5 id="addSecOfficialsTitle" class="modal-title">Add Sectoral Welfare Official</h5>
                              <button type="button" id="closeAddModal" class="btn-close">&times;</button>
                          </div>
                          <div class="modal-body">
                              <div id="addSecOfficialsError" class="alert alert-danger"></div>
                              <form id="addSecOfficialsForm">
                                      ...
                                      <div class="form-section">
                                          <div class="form-row">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" id="department" name="department" class="form-control" value="sec" required readonly>
                                              </div>
                                          </div>
                                          <div class="form-row">
                                              <div class="form-group">
                          ...
                          <div class="modal-footer">
                              <button type="submit" id="saveAddBtn" class="btn btn-primary" form="addSecOfficialsForm">Save Official</button>
...
customElements.define("add-sec-officials-modal", AddSecOfficialsModal);
