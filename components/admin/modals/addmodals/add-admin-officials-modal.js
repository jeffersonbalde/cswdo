class AddAdminOfficialsModal extends HTMLElement {
  ...
  hasUserInput() {
    ...
    // Department is auto-filled to "admin"; ignore it for user input detection
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          ...
                          <div class="modal-header">  
                              <h5 id="addAdminOfficialsTitle" class="modal-title">Add Administrative Official</h5>
                                      ...
                                      <div class="form-section">
                                          <div class="form-row">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" id="department" name="department" class="form-control" value="admin" required readonly>
                                              </div>
                                          </div>
                                          <div class="form-row">
                                              <div class="form-group">
...
customElements.define("add-admin-officials-modal", AddAdminOfficialsModal);
