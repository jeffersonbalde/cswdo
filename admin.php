...
// Check if the user is logged in and has an admin user type
$allowed_admin_roles = ['Administrator', 'WebAdministrator', 'DepartmentAdmin'];
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['user_type'], $allowed_admin_roles)) {
    // If not logged in or not an authorized admin, redirect to login page
    header("Location: login.html"); // Assuming your login page is login.html
    exit;
}
...
<head>
    ...
    />
    <title>CSWDO-Pagadian | Admin Dashboard</title>
    <!-- bootstrap import -->
    <link
...
<body>
    <div class="dashboard-container">
        <!-- Pass admin-role and admin-name from PHP session to the Web Component -->
        <admin-sidebar admin-role="<?php echo $adminRole; ?>" admin-name="<?php echo $adminName; ?>"></admin-sidebar>
